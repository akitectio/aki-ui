    ...
    return (
        <div className="space-y-8">
            <section>
                ...
                <CodeBlock
                    code={`import { Divider } from "aki-ui";
            ...
            <section>
                ...
                <div className="mb-6 grid gap-6 md:grid-cols-3">
                    ...
                    <div className="p-4 border rounded-md bg-gray-50 dark:bg-gray-800">
                        ...
                        <div className="w-full h-px bg-gray-200 dark:bg-gray-700 border-dashed border-t border-gray-300 dark:border-gray-600"></div>
                    </div>

                    <div className="p-4 border rounded-md bg-gray-50 dark:bg-gray-800">
                        <h3 className="text-sm font-medium mb-3">Dotted</h3>
                        <div className="w-full h-px bg-gray-200 dark:bg-gray-700 border-dotted border-t border-gray-300 dark:border-gray-600"></div>
                    </div>
                </div>
            ...
            <section>
                ...
                <div className="mb-6 grid gap-6 md:grid-cols-2">
                    <div className="p-4 border rounded-md bg-gray-50 dark:bg-gray-800">
                        ...
                        <div className="w-full h-px bg-blue-500 dark:bg-blue-400"></div>
                    </div>

                    <div className="p-4 border rounded-md bg-gray-50 dark:bg-gray-800">
                        <h3 className="text-sm font-medium mb-3">Custom Thickness</h3>
                        <div className="w-full h-1 bg-gray-200 rounded-full dark:bg-gray-700"></div>
                    </div>
                </div>
        ...
        <Divider color="#10B981" thickness={2} />
            ...
            <section>
                ...
                <div className="mb-6 grid gap-6 md:grid-cols-3">
                    ...
                    <div className="p-4 border rounded-md bg-gray-50 dark:bg-gray-800">
                        <div className="relative flex items-center">
                            <div className="w-20 border-t border-gray-300 dark:border-gray-600"></div>
                            <span className="mx-3 text-sm text-gray-500 dark:text-gray-400">CENTER</span>
                            <div className="flex-grow border-t border-gray-300 dark:border-gray-600"></div>
                        </div>
                    </div>
                    ...
                    <div className="p-4 border rounded-md bg-gray-50 dark:bg-gray-800">
                        <div className="relative flex items-center">
                            <div className="flex-grow border-t border-gray-300 dark:border-gray-600"></div>
                            <span className="mx-3 text-sm text-gray-500 dark:text-gray-400">RIGHT</span>
                            <div className="w-20 border-t border-gray-300 dark:border-gray-600"></div>
                        </div>
                    </div>
                </div>
    ...
    <div className="space-y-6">
      ...
      />
            ...
            <section>
                ...
                <div className="mb-6 p-4 border rounded-md bg-gray-50 dark:bg-gray-800">
                    <div className="w-full max-w-md mx-auto border border-gray-200 rounded-lg overflow-hidden shadow-sm dark:border-gray-700">
                        <div className="p-4">
                ...
                <CodeBlock
                    code={`import { Divider, Card } from "aki-ui";
