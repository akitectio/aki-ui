  ...
  private components: AkiUIComponent[] = [
    ...
    },
    {
      ...
      examples: [
        ...
        "<Slider range defaultValue={[20, 80]} showTooltip />",
        "<Slider min={0} max={1000} step={10} showMarkers />",
        '<Slider vertical size="lg" color="success" />',
      ],
      accessibility: [
        "ARIA slider role",
    ...
    },
    {
      ...
      category: "Navigation",
      description:
        "Navigation bar component with branding, menu items, and actions",
      props: [
        {
          name: "brand",
          type: "React.ReactNode",
      ...
      examples: [
        "<Navbar brand={<Logo />}><Navbar.Item>Home</Navbar.Item><Navbar.Item>About</Navbar.Item></Navbar>",
        '<Navbar fixed variant="blur" brand="MyApp"><Navbar.Menu><Navbar.Item>Dashboard</Navbar.Item></Navbar.Menu></Navbar>',
        '<Navbar size="lg"><Navbar.Brand>Company</Navbar.Brand><Navbar.Actions><Button>Login</Button></Navbar.Actions></Navbar>',
      ],
      accessibility: [
